...
data_path = PrefixedPathSetting("client/data/path", _userdir)
bin_path = PrefixedPathSetting("client/bin/path", _userdir)
mods_path = PrefixedPathSetting("client/mods/path", _userdir)
engine_path = PrefixedPathSetting("client/engine/path", _userdir)
maps_path = PrefixedPathSetting("client/maps/path", _userdir)
